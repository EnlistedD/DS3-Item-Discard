...
The DLL version of the program is highly recommended as it has an additional feature that the console version of the program doesn't have which allows you to scan for invalid items (items that don't exist in any game params). If the DLL version of the program doesn't work, then use of the Console Program is recommended, but if you don't want to use either version of the program then you can use the scripts in the "CE Scripts" folder with the program "Cheat Engine" to allow you to delete items or scan your inventory.
...
7. If you can't discard the item, then you can type "2" into the console menu to check if you have any invalid items in your inventory
8. Type "y" if you wish to scan your inventory and if any invalid items are detected then you can type "y" to have the program automatically delete them (if you wish not to scan or delete the invalid items, then you can type "n" to go back to the main menu).
...
10. Re-navigate to your DS3 folder and remove the "dinput8.dll" file from your game directory
